// source. https://github.com/microsoft/rushstack/blob/7cb9ebaa18124227d57bdd9819f73f24a1144d4d/repo-scripts/repo-toolbox/src/ReadmeAction.ts
// edit. switched Project <-> Folder positions
//
...
export class ReadmeAction extends CommandLineAction {
    ...
    protected async onExecute (): Promise<void> {
        ...
        builder.append('<!-- the table below was generated using the ./tools/repo script -->\n\n')
        builder.append('| Package | Version | Changelog | Folder |\n')
        builder.append('| ------- | ------- | --------- | ------ |\n')
        ...
        if (! readmeIsUpToDate) {
            if (this._verifyParameter.value) {
                ...
                terminal.writeErrorLine(
                    'The README.md needs to be updated. Please run \'repo readme\' to update the README.md.',
                )
